...
"""
preamble += """
- Classify queries as Hindi or English based on input language
- Never handle other languages besides Hindi and English
"""
...
def FirstLayerDMM(prompt: str, recursion_depth=0):
    ...
    if any(word in prompt.lower() for word in ['हिंदी', 'hindi']):
        return ["general"]
    # Call Cohere API
